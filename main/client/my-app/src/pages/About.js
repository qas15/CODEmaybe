        ...
        <div className="about-page">
            ...
            <header className="about-hero">
                <div className="hero-content">
                    <h1>t2 — связь, которая вдохновляет</h1>
                    <p>Мы делаем мобильную связь простой, <br/>выгодной и удобной для каждого</p>
                </div>
            </header>
            ...
            <section className="about-section">
                <div className="container">
                    <div className="about-content">
                        <h2>Кто мы такие</h2>
                        <p>
                            t2 — один из крупнейших операторов мобильной связи в России.
